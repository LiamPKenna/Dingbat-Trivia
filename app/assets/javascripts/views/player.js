...
const playerViewQuestion = (question, playerID) => {
    return (
        `
        <main>
            <style>
            ...
            ${playerViewQuestionForm(question.options, playerID)}
        </main>
        `
    );
}
const playerViewQuestionForm = (questionOptions, playerID) => {
    return (
        `
        <form id='question-form'>
            ...
            <div id='input-options'>
                ${
                    questionOptions.map(
                        (option, index) => {
                            return playerViewQuestionFormLabel(option, index, playerID);
                        }
                    ).join('\n')
                }
            </div>
...
const playerViewQuestionFormLabel = (text, index, playerID) => {
    return (
        `
...
const playerView = (playerName, playerID, question) => {
    ...
    return (
        ...
        ${playerViewQuestion(question, playerID)}
         `
    );
}
